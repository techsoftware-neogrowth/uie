...
CREATE TABLE IF NOT EXISTS `uie`.`manual_data_collection` (
  ...
  PRIMARY KEY (`idmanual_data_collection`, `category_id_category`),
  INDEX `fk_manual_data_collection_category1_idx` (`category_id_category` ASC),
