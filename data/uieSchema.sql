...
-- Table `uie`.`user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `uie`.`user` ;

CREATE TABLE IF NOT EXISTS `uie`.`user` (
...
CREATE TABLE IF NOT EXISTS `uie`.`manual_data_collection` (
  ...
  PRIMARY KEY (`id_manual_data_collection`, `fk_id_category`, `fk_id_user`),
  INDEX `fk_manual_data_collection_category1_idx` (`fk_id_category` ASC),
  INDEX `fk_manual_data_collection_user1_idx` (`fk_id_user` ASC),
  CONSTRAINT `fk_manual_data_collection_category1`
    FOREIGN KEY (`fk_id_category`)
    REFERENCES `uie`.`category` (`id_category`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_manual_data_collection_user1`
    FOREIGN KEY (`fk_id_user`)
    REFERENCES `uie`.`user` (`id_user`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `uie`.`contact_us`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `uie`.`contact_us` ;

CREATE TABLE IF NOT EXISTS `uie`.`contact_us` (
  `id_contact_us` INT NOT NULL AUTO_INCREMENT,
  `seller_type` VARCHAR(45) NULL,
  `name` VARCHAR(200) NULL,
  `email` VARCHAR(150) NULL,
  `telephone` VARCHAR(45) NULL,
  `loan_amount` VARCHAR(45) NULL,
  `avg_sales` VARCHAR(45) NULL,
  `city` VARCHAR(100) NULL,
  `num_yrs_in_business` VARCHAR(45) NULL,
  `tracking_id` VARCHAR(400) NULL,
